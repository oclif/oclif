...
_See code: [src/commands/command.ts](https://github.com/oclif/oclif/blob/v1.13.1/src/commands/command.ts)_
...
_See code: [src/commands/hook.ts](https://github.com/oclif/oclif/blob/v1.13.1/src/commands/hook.ts)_

...
export default class PackDeb extends Command {
  ...
  static flags = {
    ...
    compression: Flags.string({
      char: 'Z',
      description: 'optionally override the default compression, see available options in -Z help output from dpkg-deb --help',
      default: null,
      required: false,
    }),
  ...
  static compressionOption(value: string | undefined): string {
  ...
  async run(): Promise<void> {
    ...
    const build = async (arch: Interfaces.ArchTypes) => {
      ...
      const zOpt = this.compressionOption(flags.compression)

...
export function templateShortKey(type: keyof Config.PJSON.S3.Templates | 'macos' | 'win32' | 'deb', ext?: '.tar.gz' | '.tar.xz' | Config.IConfig.s3Key.Options, options: Config.IConfig.s3Key.Options = {root: '.'} as Record<string, string>) {
